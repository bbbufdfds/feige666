...
<script>
	import { getStore, setStore, clearStore, circleImg, clacTextLen, downloadFile, pathToBase64, base64ToPath } from '@/components/almost-lottery/utils/almost-utils.js'
  export default {
    name: 'AlmostLottery',
    props: {
      // 设计稿的像素比基准值
      ...
      lotteryBg: {
        type: String,
        default: '@/components/almost-lottery/static/almost-lottery/almost-lottery__bg2x.png'
      },
      // 抽奖按钮背景图
      actionBg: {
        type: String,
        default: '@/components/almost-lottery/static/almost-lottery/almost-lottery__action2x.png'
      },
      // 是否绘制奖品名称
      prizeNameDrawed: {
				type: Boolean,
